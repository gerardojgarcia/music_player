...
var musicContainer = document.querySelector('.music__container');
var playBtn = document.getElementById('play');
var prevBtn = document.getElementById('prev');
var nextBtn = document.getElementById('next');
var audio = document.getElementById('audio');
var progress = document.querySelector('.progress');
var progressContainer = document.querySelector('.music__container-progress');
var title = document.getElementById('title');
var cover = document.getElementById('cover');
var songLength = document.getElementById('tracktime'); // Song Title Array

var songs = ['Telex - Moskow Diskow', 'Size - Olimpico', 'Valeria - Fairy Tale', 'Size - Esta Noche', 'Vandana - Cambios en el Tiempo']; //Song Index
...
function loadSong(song) {
  ...
  cover.src = "./images/".concat(song, ".png");
}
...
function showDuration(e) {
  var trackTime = audio.currentTime / 60;
  var trackTimes = trackTime.toFixed(2);
  var trackDuration = audio.duration / 60;
  var trackLength = trackDuration.toFixed(2);
...
audio.addEventListener('timeupdate', updateProgress); //Jump-To Progress

progressContainer.addEventListener('click', setProgress); //Continuous Play

audio.addEventListener('ended', nextSong); // Track Time

audio.addEventListener('timeupdate', showDuration); //  InnerHtml
...
var musicEl = document.getElementById('music__container');
var mainBox = document.getElementById('main-box');
var subHeaderEl = document.getElementById('sub-header');
var popularAlbums = document.getElementById('popular-albums');
